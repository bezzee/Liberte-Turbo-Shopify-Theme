...
(function() {
  if (!KlaviyoSubscribe._loaded) {
          ...
          a.ajaxForm({
            ...
            beforeSubmit: function(b, d, e) {
              try {
                ...
                return KlaviyoSubscribe.log(k),
                  a.find(".error_message").show().html(k), a.trigger("klaviyo.subscribe.error"), !1
              }
            ...
            success: function(c, d, e) {
              ...
              c.success ? (KlaviyoSubscribe.setClosedModalCookie(), d = a.find(".success_message").show(),
                d.length || (d = a.parent().find(".success_message").show()), window._learnq && _learnq.push && (e = a.find('[name="email"]').val()) && (_learnq.push(["identify", {
                  $email: e
                }]), _learnq.push(["trackActivity"])), b.success_url ? window.location = b.success_url : (!0 !== b.custom_success_message && d.html(b.success_message || '<div class="klaviyo_header">Thanks for subscribing!</div><div class="klaviyo_subheader">Check your email for a confirmation message.</div>').end(), !0 === b.hide_form_on_success && (a.find(".klaviyo_field_group input, .klaviyo_form_actions").hide(),
    ...
    KlaviyoSubscribe.attachModalSignUp = function(a) {
      ...
      a.delay_seconds = a.delay_seconds || .1;
      a.delay_num_pages =
        a.delay_num_pages || 0;
      a.content = a.content || {};
    ...
    KlaviyoSubscribe._buildModalSignUp = function(a) {
      ...
      jQuery.each(b.fields, function(a, b) {
        ...
        a = "k_id_modal_" +
          b.name;
        d.append(jQuery('<div class="klaviyo_field_group" />').append(jQuery("<label />").attr("for", a).html(b.label)).append(jQuery("<input />").attr({
          type: b.type,
          id: a,
